...
bytes32 constant FILE_ROLE = keccak256("FILE_ROLE");
bytes32 constant PROFILE_ROLE = keccak256("PROFILE_ROLE");
bytes32 constant PROJECT_ROLE = keccak256("PROJECT_ROLE");
bytes32 constant GROUP_ROLE = keccak256("GROUP_ROLE");
